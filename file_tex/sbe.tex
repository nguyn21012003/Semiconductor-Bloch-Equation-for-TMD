...
\begin{equation}
	\begin{aligned}
		...
		& = \frac{e^{2}}{2 \varepsilon \varepsilon_{0}} \frac{1}{\abs{\mathbf{k}' - \mathbf{k}}} \sum_{j} C_{j}^{\lambda_{1}*}(\mathbf{k}') C_{j}^{\lambda_{4}}(\mathbf{k}) \sum_{j'} C_{j'}^{\lambda_{2}*}(\mathbf{k}) C_{j'}^{\lambda_{3}}(\mathbf{k}') \\
		& = 
	\end{aligned}
\end{equation}
